...
public class AllDetailResponse {
    ...
    private ArrayList<String> AllDetailBankProcess;
    ...
    public ArrayList<String> getAllDetailBankProcess() {
        return AllDetailBankProcess;
    }

    public void setAllDetailBankProcess(ArrayList<String> AllDetailBankProcess) {
        this.AllDetailBankProcess = AllDetailBankProcess;
    }
}
